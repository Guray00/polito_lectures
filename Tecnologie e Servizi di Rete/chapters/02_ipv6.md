...
Avviene in seguito la risposta **ICMP Neighbor Advertisement**, attraverso la quale viene inviata indietro all'all'indirizzo unicast del richiedente la risposta. La mappatura tra _IPv6_ e _MAC_ address viene memorizzata nella cache dell'host (in modo equivalente alla cache _ARP_).
