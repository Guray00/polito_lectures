...
![Broadcast collision domain](../images/04_bridge_collision_domain.png){width=300px}
...
- **dinamiche**: popolate e aggiornate dal backward learning process. Il massimo numero di entry è pari a $ 2 / 64000 $. Vengono poi eliminate quando le stazioni non esistono più o dopo un lasso di tempo _(default 300 secondi)_.
...
![Reti fisiche differenti](../images/04_virtual_lan.png){width=400px}

![VLANs](../images/04_vlans.png){width=400px}
